...
RESPONSE_SCHEMA = {
    ...
    "properties": {
        ...
        "verdict": {
            "type": "string",
            "description": "현재 조건과 가장 중요한 차이를 연결한 2~3문장 결론",
        },
        "nutrition_analysis": {
            "type": "string",
...
9. 각 섹션 역할을 겹치지 않게 작성합니다.
   - verdict: 반드시 2~3문장으로 작성합니다. 첫 문장은 현재 조건에서 왜 이 제품을 먼저 비교할지 결론을 말하고, 두 번째 문장은 가장 중요한 영양·열량 차이를 연결합니다. 세 번째 문장이 필요하면 제조사 강조점 또는 구매후기 반응 중 현재 관심사와 가장 잘 맞는 근거 하나만 자연스럽게 덧붙입니다. 아래 상세 섹션의 문장을 그대로 반복하지 않습니다.
